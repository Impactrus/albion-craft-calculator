...
export const CraftPlanner: React.FC<CraftPlannerProps> = ({
  ...
  const t = {
    ...
    netProfit: language === 'pl' ? '🌿 Leśny Plon Netto (Zysk)' : '🌿 Net Forest Yield (Profit)',
    profitMargin: language === 'pl' ? '🌱 Marża Zysku (ROI)' : '🌱 Profit Margin (ROI)',
    ...
    breakdownTitle: language === 'pl' ? '🌿 Pradawne Zestawienie Surowców i Kosztów' : '🌿 Ancient Materials & Cost Breakdown',
    ...
    journalsTitle: language === 'pl' ? '📜 Zwoje i Dzienniki Rzemieślnicze Pracowników' : '📜 Laborer Crafting Journals',
    journalsSubtitle: language === 'pl' 
      ? 'Napełniaj dzienniki rzemieślnicze sławą z leśnego rzemiosła i sprzedawaj je dla obfitego zysku'
      : 'Fill laborer journals with crafting fame and sell them for abundant profit',
